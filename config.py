...
# Four experiments: baseline vs adaptive (boost-only) for both YOLOv8s and YOLOv11s.
RUNS = [
...
A0    = 32.0 * 32.0  # reference small-object area in pixels (32x32)
W_MAX = 4.0          # max sample weight cap (boosts very-small anchors toward 1.0)
